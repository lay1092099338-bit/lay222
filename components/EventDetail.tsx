  ...
  if (!event) {
    return (
      <div className="flex flex-col items-center justify-center h-full text-gray-400">
        ...
        <p>找不到该活动详情</p>
        <button onClick={() => navigate('/plaza')} className="mt-4 text-pink-500 font-bold">返回广场</button>
      </div>
    );
  }
          ...
          <div className="text-white max-w-2xl">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <span className="text-white/60 text-xs font-bold uppercase tracking-widest flex items-center">
                ...
                {event.stats.participantCount || 100}+ 位参与中
              </span>
            </div>
          ...
          <div className="mt-6 md:mt-0 flex space-x-4">
            {event.joined ? (
               <div className="bg-pink-500/20 backdrop-blur-xl border border-pink-500/30 text-white px-8 py-4 rounded-2xl flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-[10px] font-black uppercase opacity-60">活动状态</p>
                    <p className="text-xl font-black">正在火热进行</p>
                  </div>
               </div>
            ) : (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          <section className="bg-white p-10 rounded-[32px] shadow-sm border border-gray-100">
            ...
            <div className="prose prose-pink max-w-none text-gray-600 leading-relaxed space-y-4">
              ...
              {event.fullRules && (
                <>
                  <h3 className="text-lg font-bold text-gray-800 mt-8 mb-4 underline decoration-pink-500 decoration-4 underline-offset-4">核心规则</h3>
                  ...
                  <div className={`p-6 rounded-2xl border transition-all ${
                    ...
                    <div className="flex justify-between items-start mb-2">
                       ...
                       <div className="text-right">
                          <p className="text-[10px] text-gray-400 uppercase font-black tracking-widest">奖励金额</p>
                          <p className="text-lg font-black text-yellow-600">${stage.rewardAmount} <span className="text-xs">LC</span></p>
                       </div>
                    </div>
                    <p className="text-sm text-gray-500 leading-relaxed">{stage.fullDescription || '完成相应直播任务即可获得 Lovense Cash 奖励。'}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="lg:col-span-4 space-y-8">
            ...
            <div className="bg-[#111827] rounded-[32px] p-8 text-white relative overflow-hidden shadow-2xl border border-white/10">
              ...
              <div className="relative z-10">
                <div className="flex items-center space-x-3 mb-8">
                  ...
                  <div>
                    <h4 className="font-bold text-lg">我的当前进展</h4>
                ...
                <div className="space-y-6">
                  <div>
                    <div className="flex justify-between text-xs font-black mb-2 uppercase tracking-wider">
                      <span className="text-pink-400">总体进度</span>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-white/5 p-4 rounded-2xl border border-white/5">
                      <p className="text-[10px] text-gray-500 uppercase font-black mb-1">已获奖励</p>
                    ...
                    <div className="bg-white/5 p-4 rounded-2xl border border-white/5">
                      <p className="text-[10px] text-gray-500 uppercase font-black mb-1">打赏收益</p>
          ...
          <div className="bg-white rounded-[32px] p-8 shadow-sm border border-gray-100">
            <h4 className="text-lg font-black text-gray-800 mb-6">活动实时概况</h4>
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3 text-gray-500">
                  <i className="fa-solid fa-users w-5 text-center"></i>
                  <span className="text-sm">参与模特</span>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3 text-gray-500">
                  ...
                  <span className="text-sm">总观看人次</span>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3 text-gray-500">
                  ...
                  <span className="text-sm">活动累计奖励</span>
                </div>
            ...
            <div className="mt-8 pt-8 border-t border-gray-50">
              <p className="text-xs text-gray-400 font-bold uppercase mb-4 tracking-widest">排名前三模特</p>
          ...
          <div className="bg-indigo-50 rounded-[32px] p-8 border border-indigo-100 group cursor-pointer hover:bg-indigo-100 transition-colors">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h4 className="font-bold text-indigo-900 leading-none mb-1">有任何疑问?</h4>
                <p className="text-xs text-indigo-600">点击查看常见问题或联系支持</p>
              </div>
            </div>
          </div>
        </div>
