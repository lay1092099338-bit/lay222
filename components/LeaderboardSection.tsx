    ...
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col h-full">
      <div className="p-6 border-b border-gray-50 flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h3 className="text-lg font-black text-gray-800 leading-none">活动战力榜</h3>
            <p className="text-[10px] text-gray-400 uppercase tracking-widest mt-1">Global Earnings Ranking</p>
          </div>
        </div>
        <button className="text-[10px] font-bold text-indigo-500 hover:underline uppercase tracking-tighter">
          查看全部
        </button>
      </div>
        ...
        {data.map((item, idx) => (
          ...
          >
            ...
            <div className="text-right ml-2 shrink-0">
              ...
              <p className="text-[9px] text-gray-400 font-medium">本周活跃</p>
            </div>
          </div>
        ))}
      </div>
      ...
      <div className="p-4 bg-gray-50 border-t border-gray-100 mt-auto">
        <div className="flex items-center justify-between text-[11px] text-gray-500">
          ...
          <span className="font-bold text-indigo-500 cursor-pointer hover:text-indigo-600">
            我的排名: 1,402+
          </span>
        </div>
      </div>
